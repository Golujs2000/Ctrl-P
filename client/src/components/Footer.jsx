  ...
  return (
    <footer className="bg-white text-zinc-900 border-t border-zinc-200">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 pb-8 border-b border-zinc-100">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left gap-2.5">
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 text-xs font-extrabold text-zinc-700 hover:text-[#E31B23] transition-colors"
            >
        ...
        {/* Contact & Connect Bar: Address, Mobile, Email, and Social */}
        <div className="py-8 border-b border-zinc-100 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-left">
          ...
          <div className="flex items-start gap-3.5">
            ...
            <div className="space-y-1">
              ...
              <a
                href="https://maps.google.com/?q=25.6162456,85.158286"
                target="_blank"
                rel="noreferrer"
          ...
          <div className="flex items-start gap-3.5">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[11px] text-zinc-500 font-medium">Quotes, artwork & corporate billing</p>
            </div>
          </div>

          {/* 4. Social & Connect */}
          <div className="space-y-2">
            <h4 className="text-xs font-black uppercase tracking-wider text-zinc-500">Social & Chat</h4>
            <div className="flex items-center gap-2.5">
              ...
              <a
                ...
                rel="noreferrer"
                aria-label="WhatsApp"
                className="w-9 h-9 rounded-full bg-[#25D366] text-white flex items-center justify-center hover:opacity-90 transition-opacity shadow-xs"
              >
              ...
              <a
                ...
                rel="noreferrer"
                aria-label="Instagram"
                className="w-9 h-9 rounded-full bg-gradient-to-tr from-amber-500 via-pink-500 to-purple-600 text-white flex items-center justify-center hover:opacity-90 transition-opacity shadow-xs"
              >
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                  <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/>
                </svg>
            ...
            <p className="text-[11px] text-zinc-500 font-medium">WhatsApp support available</p>
          </div>
        ...
        <div className="pt-8 text-center text-xs font-semibold text-zinc-500 space-y-2">
          ...
          <p className="text-[11px] text-zinc-400">
            Kalyani Complex, Bari Path, Langar Toli Chauraha, Patna - 800004 • Direct Offset & Digital Press
          </p>
        </div>
