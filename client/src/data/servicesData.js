export const servicesList = [
  ...
  // 3. INTERNATIONAL ORDERS & WORLDWIDE SHIPPING
  {
    ...
    heroImage: '/assets/branded-paper-carry-bag-ctrlp.jpg',
  ...
  // 6. URDU DESIGN WORK & CALLIGRAPHY
  {
  ...
  // 7. LETTERHEAD & LETTER PAD PRINTING
  {
  ...
  // 10. PROMOTIONAL SUNSHADE UMBRELLAS
  {
  ...
  // 11. PACKAGING BOXES & DIELINE DESIGN
  {
    ...
    gallery: [
      ...
      '/assets/branded-paper-carry-bag-ctrlp.jpg',
      '/assets/candy-wrapper-packaging-vikram-pulse-kachha-aam.jpg',
      '/assets/candy-wrapper-packaging-vikram-orange-candy.jpg'
    ]
  },

  // 12. CERTIFICATES & AWARD PRINTING
  {
  ...
  // 13. BUSINESS CARD PRINTING
  {
    ...
    materials: [
      '300 GSM & 350 GSM Art Board',
      'Velvet Soft-Touch Lamination',
      'Matte & Gloss Thermal Finish',
      'Raised Spot UV & Metallic Foil',
      'Textured & Kraft Eco-Cardstock',
      'Translucent & Frost PVC Cards'
    ],
    sizes: [
      'Standard Indian: 89 x 54 mm (3.5 x 2.1 inch)',
      'Square: 65 x 65 mm (2.5 x 2.5 inch)',
      'Slim Executive: 85 x 40 mm',
      'Folded Mini Brochure Cards'
    ],
    pricing: 'Starts at ₹250 for 100 cards (Bulk rates available)',
    turnaround: 'Same day for digital / 24-48 hrs for luxury finishes',
    faqs: [
      {
  ...
  // 14. BROCHURE & PROSPECTUS PRINTING
  {
    ...
    materials: [
      ...
      'Creasing and Scoring for clean folds',
      'Spot UV coating on cover titles'
    ],
    sizes: [
  ...
  // 15. FLYER & PAMPHLET PRINTING
  {
    ...
    turnaround: 'Same day printing available for urgent campaigns',
    faqs: [
      {
        q: 'What is the minimum order quantity for flyers?',
        a: 'We print from 500 copies up to 100,000+ copies with fast delivery across Patna.'
      }
    ],
    gallery: [
  ...
  // 19. ID CARDS & LANYARDS
  {
    ...
    heroImage: '/assets/corporate-id-card-lanyard-holder-etscab.jpg',
    badge: 'High Security',
    overview: 'Complete employee and student identification systems for schools, universities (like North St. Williams Academy), hospitals, and corporate offices. Printed using high-resolution thermal re-transfer technology that will never peel or fade.',
  ...
  // 24. SIGNAGE & STOREFRONT BRANDING
  {
    ...
    turnaround: '4-8 days including fabrication and fitting',
    faqs: [
      {
        q: 'Do you provide on-site measurements in Patna?',
        a: 'Yes, our technician visits your shop or office anywhere in Patna for laser measurements.'
      }
    ],
    gallery: [
      '/assets/ctrlp-storefront-board-front-view.jpg',
