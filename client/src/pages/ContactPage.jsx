          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="aspect-[4/3] rounded-2xl overflow-hidden border border-zinc-200 shadow-sm bg-zinc-100">
                <img decoding="async" loading="lazy" src="/assets/ctrlp-storefront-kalyani-complex-plaza-view.jpg" alt="Kalyani Complex Plaza View" className="w-full h-full object-cover" />
              </div>
              <div className="aspect-[4/3] rounded-2xl overflow-hidden border border-zinc-200 shadow-sm bg-zinc-100">
                <img decoding="async" loading="lazy" src="/assets/ctrlp-office-design-workstations-pc-setup.jpg" alt="Design PC Workstations" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
