          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="aspect-[4/3] rounded-2xl overflow-hidden border border-zinc-200 shadow-sm bg-zinc-100">
                <img src="/assets/storefront-kalyani-complex-plaza.jpeg" alt="Kalyani Complex Plaza View" className="w-full h-full object-cover" />
              </div>
              <div className="aspect-[4/3] rounded-2xl overflow-hidden border border-zinc-200 shadow-sm bg-zinc-100">
                <img src="/assets/office-workstations-pc-setup.jpeg" alt="Design PC Workstations" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
